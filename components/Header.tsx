...
const Header: React.FC<HeaderProps> = ({ apiKey, isAdmin, terminalName, onLogout, onGoHome }) => {
  return (
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">
            {terminalName || 'Code Buddy'}
          </h1>
          <p className="text-xs text-gray-500">
            {isAdmin ? 'Admin Dashboard' : 'Powered by greybrain.ai'}
          </p>
        </div>
      </div>
        ...
        {apiKey && (
          <>
            ...
            <button
              ...
              title={isAdmin ? 'Exit Admin' : 'Logout'}
            >
